...
@app.command()
def add_contrat(client_id: int, status: str, start_date: str, end_date: str, price: int, payment_received: str, is_signed: bool, author_id):
...
@app.command()
def update_contrat(contrat_id: int, status: str = None, start_date: str = None, end_date: str = None, price: int = None, payment_received: str = None, is_signed: bool = None, author_id: int = None):
    user_info = get_user_info()
    if user_info is None:
        typer.echo("Tu dois te connecter d'abord.")
        return
...
# @app.command()
# def update_contrat(contrat_id: int, status: str = None, start_date: str = None, end_date: str = None, price: int = None, payment_received: str = None, is_signed: bool = None):
#     user_info = get_user_info()
#     if user_info is None:
#         typer.echo("Tu dois te connecter d'abord.")
#         return
